...
DATA_FILE = "Blockchain excel.xlsx"   # Apni file ka naam yahan rakho
...
if st.button("Start Training"):
    ...
    synth = CTGANSynthesizer(metadata, epochs=50, batch_size=200)  # epochs kam rakhe streamlit speed ke liye
    synth.fit(df)
